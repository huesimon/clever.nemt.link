    ...
    <div>
        ...
        <dl
            ...
            <div class="px-4 py-5 sm:p-6">
                <dt class="text-base font-normal text-gray-900">Total Locations</dt>
            ...
            <div class="px-4 py-5 sm:p-6">
                <dt class="text-base font-normal text-gray-900">Created This Month</dt>
                <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
                    <div class="flex items-baseline text-2xl font-semibold text-indigo-600">
                        58.16%
            ...
            <div class="px-4 py-5 sm:p-6">
                <dt class="text-base font-normal text-gray-900">Created This Week</dt>
                <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
                    <div class="flex items-baseline text-2xl font-semibold text-indigo-600">
                        24.57%
